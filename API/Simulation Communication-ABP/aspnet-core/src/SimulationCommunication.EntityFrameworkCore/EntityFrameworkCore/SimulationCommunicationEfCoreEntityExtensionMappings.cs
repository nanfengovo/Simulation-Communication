...
public static class SimulationCommunicationEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE SimulationCommunicationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
